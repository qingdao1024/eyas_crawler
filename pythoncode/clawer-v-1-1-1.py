...
# 判断你是否是下载链接
dowloadrelist = [r'^http://www.wandoujia.com/apps/.*/binding?.*$',r'^http://www.wandoujia.com/apps/.*/download$',r'^http://www.wandoujia.com/apps/.*/binding$']
def judgedownload(url):
	flag = False #True or False
	for a in dowloadrelist:
		m = re.match(a,url)
		if m:
			flag = True
